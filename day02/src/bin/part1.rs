...
impl CubeSetResult {
    pub fn from_game(game_line: &str) -> Self {
        todo!();
        /*
        let line = game_line.split(":").collect::<Vec<&str>>();
    ...
    /// Returns true if result is possible, false otherwise.
    pub fn is_possible(&self) -> bool {
        self.red <= MAX_RED_CUBES && self.blue <= MAX_BLUE_CUBES && self.green <= MAX_GREEN_CUBES
    }
}
...
mod tests {
    ...
    fn verify_example() {
        ...
        //assert_eq!(gonna_test_something(example_input), 8);
    }
}

const PUZZLE_INPUT: &str = "Game 1: 13 red, 18 green; 5 green, 3 red, 5 blue; 5 green, 9 red, 6 blue; 3 blue, 3 green
